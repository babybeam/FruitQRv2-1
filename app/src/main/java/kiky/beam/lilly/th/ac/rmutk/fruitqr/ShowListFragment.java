        ...
        switch (typeUserAnInt) {
            case 1:
                ...
                try {
                    ...
                    ShowListAdapter showListAdapter = new ShowListAdapter(getActivity(), nameStringArrayList, dateStringArrayList, amountStringArrayList, unitStringArrayList, imageStringArrayList, new OnClickItem() {
                        @Override
